...
function FellowPerformance({ scores: data }) {
    ...
    return (
        <Container>
            <h4 className="text-capitalize fw-bolder mb-4">
                Manage Fellow Performance
            </h4>
            <Card className="py-4 border-0">
                <GlobalFilter filter={globalFilter} setFilter={setGlobalFilter} />
                <table {...getTableProps()} className="table table-borderless mt-4 asm-table">
                    ...
                    <tbody {...getTableBodyProps()}>
                        {page.map((row) => {
                            prepareRow(row)
                            return (
                                <tr {...row.getRowProps()} className="align-middle asm-border-top">
                                    {row.cells.map((cell) => {
...
export default FellowPerformance;
